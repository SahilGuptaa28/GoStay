...
//         bg-[url("src/assets/hero.png")] bg-no-repeat bg-cover bg-center h-screen '>
...
//          max-w-xl mt-4'>Elevate Your Stay with Elite Comfort</h1>
//          <p className='max-w-130 mt-2 text-sm md:text-base'>Step into a world of luxury and comfort at top-tier hotels and resorts. Start your journey today.
//          </p>
    ...
    return (
        ...
        >
            ...
            <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>
                Elevate Your Stay with Elite Comfort
            </h1>
            <p className='max-w-130 mt-2 text-sm md:text-base'>
                Step into a world of luxury and comfort at top-tier hotels and resorts. Start your journey today.
            </p>
