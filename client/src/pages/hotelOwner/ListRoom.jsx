...
function ListRoom() {
    ...
    return (
        <div>
         <Title align='left' font='outfit' title='Room Listings' subtitle='View, edit or manage all listed rooms. Keep the information up-to-date to
                ...
                <table className='w-full'>
                     <thead className='bg-gray-50'>
                        <tr>
                            ...
                            <th className='py-3 px-4 text-gray-800 font-medium  max-sm:hidden'>price / night</th>
