...
function Addroom() {
    ...
    const onSubmitHandler = async (e) => {
        ...
        if (inputs.pricePerNight === "" || isNaN(inputs.pricePerNight)) {
    ...
    return (
        <form onSubmit={onSubmitHandler}>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            setInputs({
                                ...inputs,
                                pricePerNight: value === "" ? "" : Number(value),
                            });
                        }}
                    />
                </div>
            ...
            {/* Submit */}
            <button
                className='bg-primary hover:bg-indigo-800 text-white px-8 py-2 rounded mt-8 cursor-pointer'
                disabled={loading}
            >
