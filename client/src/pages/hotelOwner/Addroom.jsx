...
function Addroom() {
    ...
    return (
        ...
        <form>
           ...
           and accurate room details, pricing and amenties to enhance the user booking
           experience.' />
           ...
           <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
            {Object.keys(inputs.amenties).map((amenity,index)=>(
                <div key={index}>
                    <input type="checkbox" id={`amenities ${index+1}`} checked={inputs.amenties[amenity]}
                    onChange={()=>setInputs({...inputs,amenties:{...inputs.amenties,[amenity]:!inputs.amenties[amenity]}})}/>
           ...
           <button className='bg-primary hover:bg-indigo-800 text-white px-8 py-2 rounded mt-8 cursor-pointer'>
            Add Room
           </button>
