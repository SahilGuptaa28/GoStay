...
function AllRooms() {
    ...
    // filter and sort rooms based on the selecte filters and sort option
        ...
        justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24'>
            <div>
                <div className='flex flex-col items-start text-left'>
                    ...
                    <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take Advantage our limied-time offers and special packages
                ...
                {filteredRooms.map((room) => (
                    <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                        <img onClick={() => { navigate(`/rooms/${room._id}`); scrollTo(0, 0) }} src={room.images[0]} alt="hotel-image" title="View Room Details" className='max-h-65 
                ...
                <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border-b border-gray-300 ${openFilters && "border-b"}`} >
                    ...
                    <div className='text-xs cursor-pointer'>
                        ...
                        <span
                            ...
                            className={`lg:hidden ml-3 cursor-pointer text-gray-600 ${openFilters ? '' : 'hidden'}`}
                            title="Clear filters"
                        >
                            CLEAR
                        </span>
